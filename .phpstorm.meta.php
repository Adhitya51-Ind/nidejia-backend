...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\User\Desktop\instal_laravel\first-app\nidejia-backend\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Users\\User\\Desktop\\instal_laravel\\first-app\\nidejia-backend\\public\\storage','logging.default',
...
'filament.admin.resources.listings.index','filament.admin.resources.listings.create','filament.admin.resources.listings.edit','filament.admin.resources.transactions.index','filament.admin.resources.transactions.create',
'filament.admin.resources.transactions.edit','sanctum.csrf-cookie','livewire.update',
'livewire.upload-file','livewire.preview-file','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','listing.index','listing.show','register','login',
'password.email','password.store','verification.verify','verification.send','logout',);
